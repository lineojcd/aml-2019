...
def baseline_model():
    # create model
    model = Sequential()
    model.add(Dense(200, input_dim=17813, activation='relu', kernel_initializer='random_uniform'))
...
pipeline = Pipeline([
    ...
    ('nn', KerasClassifier(build_fn=baseline_model, epochs=5, batch_size=100, verbose=0)),
])

param_grid = {
    'nn__batch_size': [20, 40, 80, 160, 320]
}
